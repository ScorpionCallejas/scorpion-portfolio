...
const footerLinks = [
  ...
  },
  {
    title: "Servicios",
    links: [
      { label: "Despliegue y CI/CD", href: "#servicios" },
      { label: "Docker y Contenedores", href: "#servicios" },
      { label: "Administración Linux", href: "#servicios" },
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-4 gap-12 pb-12">
          ...
          >
            ...
            <p className="text-gray-400 leading-relaxed mb-6 max-w-sm">
              DevOps e infraestructura para proyectos que necesitan estabilidad,
              escalabilidad y despliegues confiables.
            </p>
            ...
            >
              ...
              <ul className="space-y-3">
                {section.links.map((link) => (
                  <li key={link.label}>
                    <a href={link.href} className="text-gray-400 hover:text-white transition-colors text-sm inline-flex items-center gap-2 group">
        ...
        >
          <p className="text-sm text-gray-500">
            © {currentYear} Scorpion DevOps. Todos los derechos reservados.
          </p>
